const circulo = function(centroX, centroY, distancia) {
  circle(centroX, centroY, distancia * 2);
}

const cuadrado = function(centroX, centroY, distancia) {
  rect(centroX - distancia, centroY - distancia, distancia * 2, distancia * 2);
}

const triangulo = function(centroX, centroY, distancia) {
  triangle(
    centroX - distancia, 
    centroY + distancia, 
    centroX + distancia,
...
function setup() {
  ...
  progresionAritmetica(50, 2, crearArrayColores(0, 170, 200), cuadrado);
  progresionAritmetica(300, -5, crearArrayColores(100, 0, 0), cuadrado);
  progresionAritmetica(300, -15, crearArrayColores(0, 180, 0), circulo);
  progresionAritmetica(0, 25, crearArrayColores(70, 120, 0), circulo);
  progresionAritmetica(400, -15, crearArrayColores(190, 190, 0), triangulo);
